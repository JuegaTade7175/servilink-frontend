...
export const bookingsApi = {
  ...
  byProfessional: (professionalId: number) =>
    api
      .get<Booking[]>('/api/bookings/professional', { params: { professionalId } })
      .then((r) => r.data),
};
...
export const availabilityApi = {
  getByProfessional: (professionalId: number) =>
    api
      .get<Availability[]>(`/api/availability/professional/${professionalId}`)
      .then((r) => r.data),
  getByDay: (professionalId: number, day: DayOfWeek) =>
    api
      .get<Availability[]>(
        `/api/availability/professional/${professionalId}/day`,
        { params: { day } }
      )
      .then((r) => r.data),
